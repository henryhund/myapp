...
describe ProfilesController do
  ...
  let(:valid_attributes) { { "tagline" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved profile as @profile" do
        ...
        post :create, {:profile => { "tagline" => "invalid value" }}, valid_session
        assigns(:profile).should be_a_new(Profile)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested profile" do
        ...
        Profile.any_instance.should_receive(:update_attributes).with({ "tagline" => "MyText" })
        put :update, {:id => profile.to_param, :profile => { "tagline" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the profile as @profile" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Profile.any_instance.stub(:save).and_return(false)
        put :update, {:id => profile.to_param, :profile => { "tagline" => "invalid value" }}, valid_session
        assigns(:profile).should eq(profile)
      end
